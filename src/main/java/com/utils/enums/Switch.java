...
public enum Switch {
    /**
     * 否|未删除|未读|待处理|下架|未验证|未完成|不支持|未确认|无效|未过期|暂停
     */
    NO(" 否|未删除|未读|待处理|下架|未验证|未完成|不支持|未确认|无效|未过期|暂停"),
    /**
     * 是|已删除|已读|已处理|上架|已验证|已完成|  支持|已确认|有效|已过期|启动
     */
    YES("是|已删除|已读|已处理|上架|已验证|已完成|  支持|已确认|有效|已过期|启动");
    /**
     * 枚举属性说明
     */
